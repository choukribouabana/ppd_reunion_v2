     ...
     userService.modifieuser(this.state.mod._id,values).then( (response)=> {
       ...
       .catch(error => {
        ...
        // actions.isSubmitting= false;
          ...
          initialValues={{name: this.state.mod.name, email: this.state.mod.email, password: '',username: this.state.mod.username, poste:this.state.mod.poste,prenom:this.state.mod.prenom,date: null, roles : "user" ,Ajoutimage:undefined}}
